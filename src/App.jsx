        ...
        <section className="showcase">
            <div className="container-fluid p-0">
                <div className="row g-0">
                    <div className="col-lg-6 order-lg-2 text-white showcase-img" style= {{backgroundImage: `url('src/image/bg-showcase-1.jpg')`,alt : "jd"}}></div>
                ...
                <div className="row g-0">
                    <div className="col-lg-6 text-white showcase-img" style= {{backgroundImage: `url('src/image/bg-showcase-2.jpg')`}} ></div>
                ...
                <div className="row g-0">
                    <div className="col-lg-6 order-lg-2 text-white showcase-img" style= {{backgroundImage: `url('src/image/bg-showcase-3.jpg')` }}></div>
                    <div className="col-lg-6 order-lg-1 my-auto showcase-text">
                ...
                <div className="row">
                    <div className="col-lg-4">
                        <div className="testimonial-item mx-auto mb-5 mb-lg-0">
                            <img className="img-fluid rounded-circle mb-3" src="src/image/testimonials-1.jpg" alt="Margaret" />
                            <h5>Margaret E.</h5>
                    ...
                    <div className="col-lg-4">
                        <div className="testimonial-item mx-auto mb-5 mb-lg-0">
                            <img className="img-fluid rounded-circle mb-3" src="src/image/testimonials-2.jpg" alt="Fred" />
                            <h5>Fred S.</h5>
                    ...
                    <div className="col-lg-4">
                        <div className="testimonial-item mx-auto mb-5 mb-lg-0">
                            <img className="img-fluid rounded-circle mb-3" src="src/image/testimonials-3.jpg" alt="..." />
                            <h5>Sarah W.</h5>
